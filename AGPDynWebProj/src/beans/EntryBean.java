...
public class EntryBean {
	...
	private int activityIntensity = 3; // number of activity (1-3)
	...
	private boolean hotelChange=true;
	...
	public String startStays() {		
		...
		if(this.budget <= 300 || this.duration<=0 || this.numberOfPerson<=0 || activityIntensity <=0 ) return "index";
